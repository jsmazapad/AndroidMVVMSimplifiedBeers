...
import es.jsm.mvvm.beer.config.StringConfig;
import es.jsm.mvvm.beer.core.data.network.NetworkErrorTreatmentInterface;
import es.jsm.mvvm.beer.core.data.network.exceptions.InternalBackendException;
import es.jsm.mvvm.beer.core.data.network.exceptions.InvalidSessionException;
import es.jsm.mvvm.beer.core.data.network.exceptions.NotFoundException;
 ...
 */
public class BeersNetworkErrorTreatment implements NetworkErrorTreatmentInterface {
